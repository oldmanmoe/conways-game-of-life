...
Its evolution is determined by its initial state, requiring no further input. You set up a "grid" of cells, and they live, die, or multiply based on four simple rules:
